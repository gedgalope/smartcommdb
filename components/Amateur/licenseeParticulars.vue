  ...
  <v-container>
    ...
    <v-form ref="licenseeParticulars" v-model="validParticulars">
      <v-row dense>
        ...
        <v-col cols="6">
          <v-text-field v-model="ARLSeries" :rules='[dataRequired]' dense outlined label="ARL">
          </v-text-field>
        </v-col>
        <v-col cols="6">
          <v-text-field v-model="AROCSeries" :rules='[dataRequired]' dense outlined label="AROC">
          </v-text-field>
        </v-col>
        ...
        <v-col cols="6">
          <v-row dense>
            ...
            <v-col cols="12">
              <v-text-field v-model="formNumber" :rules='[dataRequired]' dense outlined label="Form No">
              </v-text-field>
            </v-col>
            <v-col cols="12">
